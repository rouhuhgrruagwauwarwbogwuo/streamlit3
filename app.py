...
def extract_face_retina(pil_img):
...
with tab1:
    ...
    if uploaded_image:
        ...
        face_img = extract_face_retina(pil_img) or extract_face_opencv(pil_img)
        if face_img:
    ...
    if uploaded_video:
        ...
        while cap.isOpened() and frame_idx < max_frames:
            ...
            if frame_idx % 3 == 0:
                ...
                face_img = extract_face_retina(pil_frame) or extract_face_opencv(pil_frame)
                if face_img:
